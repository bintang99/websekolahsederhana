...
<!-- Histats.com  END  -->
					...
					<p class="para-agileits-w3layouts">
						...
						<a href="mailto:<?= $set['email']?>	" class=" text-white">
																					<?= $set['email']?>					
																		</a>
					</p>
				</div>
		...
		<div class="copyright-agiles py-3">
			<div class="container">
				<div class="row">
					<p class="col-lg-8 copy-right-grids text-white text-lg-left text-center mt-lg-1">© 2018 <a href="<?php echo base_url()?>" target="_blank"><?= $set['nama'] ?>	</a>
					</p>
					<!-- social icons -->
					<div class="social-icons text-lg-right text-center col-lg-4 mt-lg-0 mt-3">
						<ul class="list-unstyled">
							<li>
								<a href="
									<?= $set['fb'] ?>					
								" target="_blank" class="fab fa-facebook-f icon-border facebook rounded-circle"> </a>
							</li>
							<li class="mx-2">
								<a href="
									<?= $set['twit'] ?>					
								" target="_blank" class="fab fa-twitter icon-border twitter rounded-circle"> </a>
							</li>
							<li>
								<a href="<?= $set['ig'] ?>					
								" class="fab fa-instagram icon-border googleplus rounded-circle"> </a>
							</li>
						</ul>
						</div>
					<!-- //social icons -->
