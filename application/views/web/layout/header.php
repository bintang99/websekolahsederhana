...
<head>
	...
	<meta charset="UTF-8" />
	<meta name="keywords" content="<?= $set['deskripsi']?>"/>
	<script>
	...
	<link rel="icon" type="image/png" href="<?= base_url(); ?>assets/<?= $set['logo']; ?>">
<div id="fb-root"></div>
...
<body>
	...
	<header>
			...
			<div class="container">
				<div class="row">
					<h1 class="text-capitalize text-white col-7">
						<img height="35" width="35" src="<?= base_url(); ?>assets/<?= $set['logo']; ?>" class=" text-dark rounded-circle mr-2">Welcome to <?= $set['nama'] ?></h1>
					<!-- social icons -->
					<div class="social-icons text-right col-5">
						<ul class="list-unstyled">
							...
							<li>
								<a href="<?= $set['fb'] ?>" target="_blank" class="fab fa-facebook-f icon-border facebook rounded-circle"> </a>
							</li>
							<li class="mx-2">
								<a href="<?= $set['twit'] ?>" target="_blank" class="fab fa-twitter icon-border twitter rounded-circle"> </a>
							</li>
							<li>
								<a href="<?= $set['ig'] ?>" class="fab fa-instagram icon-border googleplus rounded-circle"> </a>
							</li>
						</ul>
					</div>
					<!-- //social icons -->
		...
		<div class="middle-w3ls-nav py-2">
			<div class="container">
				<div class="row">
					<a class="logo font-italic font-weight-bold col-lg-4 text-lg-left text-center" href="<?= base_url(); ?>"><img height="70" src="<?= base_url('assets/') ?><?= $set['header'] ?>"> </a>
