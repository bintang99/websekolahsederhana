	...
	<div class="blog-w3l py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize font-weight-light text-dark text-center mb-5">Kegitan
			...
			<div class="row blog-content pt-md-4">
				...
				<div class="col-lg-8 blog_section">
					...
					<div class="card my-4">
						<img class="card-img-top" src="<?php echo base_url()?>/assets/upload/tefa_kegiatan/<?php echo $row->foto?>" alt="">
						<div class="card-body text-center">
							...
							<p class="card-text"><?php echo substr($row->des, 0, 100)?></p>
							<a href="<?php echo base_url()?>tefa/baca/<?php echo $row->slug?>" class="btn btn-primary blog-button mt-3">Read More</a>
						</div>
					</div>
					<?php }?>
