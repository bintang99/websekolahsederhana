<div class="content-wrapper">
  ...
  <section class="content container-fluid">
    <div class="box">
      ...
      <div class="box-body">
        <form action="<?php echo site_url('backend/tefa_kegiatan/add_tefa_kegiatan'); ?>" method="post" role="form" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            <label class="col-md-2">Tanggal</label>
             <div class="col-md-10"><input type="date" name="tgl" required class="form-control"></div>
          </div>
          <div class="form-group row">
