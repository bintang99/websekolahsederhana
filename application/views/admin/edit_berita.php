  ...
  <section class="content container-fluid">
    <div class="box">
      ...
      <?php foreach ($beritadata as $row): ?>
        <form action="<?php echo site_url('backend/berita//update_berita'); ?>" method="post" enctype="multipart/form-data">
            <input type="hidden" value="<?= $row->id_berita ?>" name="id_berita" class="form-control" >
            <input type="hidden" name="gambarlama" value="<?=$row->gambar;?>" required class="form-control">
            ...
            <div class="form-group row">
              ...
              <div class='col-md-10'>
              <select class="form-control" name="id_ktg_berita">
              <?php 
              foreach ($kategori as $ktg) {
                if ($ktg->id_ktg_berita == $row->id_ktg_berita) {
                  echo "<option value='".$ktg->id_ktg_berita."' selected>".$ktg->kategori."</option>";
                }else{
            ...
            <div class="form-group row">
              ...
              <div class="col-md-10"><textarea id="editor1" name="konten"><?=$row->konten?></textarea></div>
            </div>
            <br>
